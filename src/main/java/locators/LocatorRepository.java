...
public final class LocatorRepository {
    ...
    static {
        ...
        L.put("region", By.xpath("//span[text()='Mumbai']")); 

        // Sign In
        L.put("signInBtn", By.xpath("//*[text()='Sign in']"));
        L.put("mobileNumberBox", By.id("userMobileNumber"));
        L.put("continueBtn", By.xpath("//div[@class='sc-zgl7vj-8 hpVUcY'][normalize-space()='Continue']"));
        L.put("otp", By.xpath("//input[@type='tel']"));
//        L.put("otpContinueBtn", By.xpath("/html/body/div[1]/div/div[4]/div/div/div[2]/div/div[3]/div/div"));
        L.put("otpContinueBtn", By.xpath("(//div[@class='sc-zgl7vj-8 hpVUcY'])"));
        ...
        L.put("invalidErrorMsg", By.xpath("//*[text()='Invalid mobile number']"));
